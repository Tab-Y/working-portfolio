...
import codemates from './img/p3-screenshot.png';
        ...
        <>
            ...
            <div id='projects'>
                ...
                <div className='grid'>
                    ...
                    <div className='projectCard'>
                        <h4 className='over-img'>Codemates<p>React, javascript, HTMl, CSS, Bootstrap, Mongoose, Express, Node.js</p></h4>
                        <a href="https://codemates-app.herokuapp.com/"><img src={codemates} alt="screen shot of codemates" /></a>
                    </div>
                    {/* <div className='projectCard'>
